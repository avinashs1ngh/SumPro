...
export const SERVICES: ServiceItem[] = [
  {
    ...
    icon: Code2,
    image: 'https://images.unsplash.com/photo-1571171637578-41bc2dd41cd2?q=60&w=800&auto=format&fit=crop',
    features: [
  ...
  },
  {
    ...
    icon: Server,
    image: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?q=60&w=800&auto=format&fit=crop',
    features: [
  ...
  },
  {
    ...
    icon: Users,
    image: 'https://images.unsplash.com/photo-1521737604893-d14cc237f11d?q=60&w=800&auto=format&fit=crop',
    features: [
  ...
  },
  {
    ...
    icon: ShieldCheck,
    image: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?q=60&w=800&auto=format&fit=crop',
    features: [
  ...
  },
  {
    ...
    icon: Cloud,
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?q=60&w=800&auto=format&fit=crop',
    features: [
