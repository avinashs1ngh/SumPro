          ...
          {SERVICES.map((service, index) => (
            ...
            >
              <div
                ...
                className="glass-card rounded-2xl overflow-hidden group flex flex-col h-full hover:border-primary/50 hover:translate-y-[-8px] transition-all duration-300 cursor-pointer"
              >
